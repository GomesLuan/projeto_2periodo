...
char tela_alterar_vestimenta(char *num_p, char *num_m, char *num_g, char *preco) {
    ...
    printf("#       1 - Número de unidades de tamanho P: (%s)\n", num_p);
    printf("#       2 - Número de unidades de tamanho M: (%s)\n", num_m);
    printf("#       3 - Número de unidades de tamanho G: (%s)\n", num_g);
    printf("#       4 - Preço da locação diária (R$): (%s)\n", preco);
